  ...
  return (
    ...
    >
      ...
      <div className="section-container relative z-10">
        <div className="flex flex-col items-center justify-center text-center min-h-[80vh] max-w-4xl mx-auto space-y-8">
          {/* Section label */}
          <motion.div
          ...
          <div className="space-y-3">
            <motion.h1
              className="font-clash font-bold text-5xl md:text-6xl lg:text-7.5xl text-text-primary leading-[1.1] tracking-tight"
            ...
            >
              ...
              <br />
              <span className="text-gradient">Grow Through Strategy.</span>
            </motion.h1>
          </div>
